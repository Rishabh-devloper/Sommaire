    ...
    <section className="relative">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 
                    ...
                    bg-linear-to-br from-emerald-500 via-teal-500 
                    to-cyan-500 opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72rem]
        ...
        <div className="flex flex-col items-center  text-center space-y-4 ">
          ...
          <div className="flex justify-center items-center px-2 sm:px-2 lg:px-6">
